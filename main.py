...
train_dataset = dataset.DINCAEDataset(
    data_dir=train_data_dir, transform=train_transform, target_transform=target_transform)
...
val_dataset = dataset.DINCAEDataset(
    data_dir=test_data_dir, transform=train_transform, target_transform=target_transform)
val_dataloader = dataloader.DataLoader(train_dataset, batch_size=batch_size, shuffle=False, drop_last=True)
